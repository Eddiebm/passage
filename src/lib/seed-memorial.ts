...
export const CHRISTIAN_EXAMPLE_SLUG = 'samuel-mensah-2026' as const
...
export function getExampleMemorialBlob(): StoredMemorialBlob {
  ...
  const stakeholders: Stakeholder[] = [
    {
      ...
      role_label: 'Officiant — St. Mary’s Anglican Church, Accra',
      phone: '+233241000001',
      visibility: 'public',
    },
    {
  ...
  const memorial: Memorial = {
    ...
    status: 'live',
    memorial_mode: 'full',
    deceased_name: EXAMPLE_NAMES.male.display,
    deceased_title: 'Of blessed memory',
    deceased_family_house: 'The family',
    deceased_community: 'Accra',
    date_of_birth: '1948-03-22',
    date_of_passing: '2026-01-08',
    photo_url: CHRISTIAN_EXAMPLE_SEED_PHOTO,
    gallery_urls: [...CHRISTIAN_EXAMPLE_SEED_GALLERY],
    biography:
      'A devoted father and grandfather. Known for his quiet strength, generosity to young people, and unwavering commitment to truth and dignity.',
    ...
    surviving_family: [
      ...
      },
      {
        title: 'Son',
        name: 'Mr. David',
        note: 'Family spokesperson and programme coordinator',
      },
      {
        title: 'Daughter',
        name: 'Dr. Elizabeth',
    ...
    allied_families: ['Allied families and friends'],
    stakeholders,
    remembrance: {
      scripture: {
    ...
    wind_down_meetings: [
      {
        ...
        location: "St. Mary's Anglican Church, Accra",
  ...
  const events: MemorialEvent[] = [
    {
      ...
      location: 'Family residence, Accra',
      online_link: '',
    ...
    },
    {
      ...
      notes: 'Procession follows to the family residence.',
      sort_order: 1,
    },
    {
      id: uuid(),
  ...
  const tributes: Tribute[] = [
    {
      ...
      message:
        'Samuel taught me that leadership is service. We will miss his laughter in the compound.',
      video_url: undefined,
...
export function getGhanaMuslimExampleMemorialBlob(): StoredMemorialBlob {
  ...
  const memorial: Memorial = {
    ...
    deceased_name: EXAMPLE_NAMES.female.display,
    deceased_title: 'Of blessed memory',
    deceased_family_house: 'The family',
    deceased_community: 'Accra',
    ...
    biography:
      'Beloved mother and grandmother. Known for her hospitality at Ramadan, her counsel to young women, and her quiet generosity to neighbours in need — always with grace and modesty.',
