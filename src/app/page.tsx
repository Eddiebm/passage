  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <main className="passage-memorial-main mx-auto flex w-full flex-1 flex-col gap-14 px-4 py-16">
        ...
        >
          <p className="text-xs uppercase tracking-[0.2em] text-[var(--passage-muted)]">Appearances</p>
          <p className="mt-2 font-[family-name:var(--passage-font-display)] text-xl font-semibold text-[var(--passage-heading)]">
            Browse {VISUAL_THEME_COUNT}+ appearance styles
          </p>
          <p className="mt-2 text-sm leading-relaxed text-[var(--passage-muted)]">
            Funeral-appropriate themes — programme, kente, night vigil, regional palettes, and more. Open the
            design lab to preview every option before you publish.
          </p>
